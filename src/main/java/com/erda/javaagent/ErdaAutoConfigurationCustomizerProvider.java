...
public class ErdaAutoConfigurationCustomizerProvider
  ...
  private SdkTracerProviderBuilder configureSdkTracerProvider(
    ...
    return tracerProvider
        .setIdGenerator(new ErdaIdGenerator())
        .setSpanLimits(SpanLimits.builder().setMaxNumberOfAttributes(1024).build())
        .addSpanProcessor(new ErdaSpanProcessor())
        .addSpanProcessor(SimpleSpanProcessor.create(new ErdaSpanExporter()));
  }
  ...
  private Map<String, String> getDefaultProperties() {
    ...
    properties.put("otel.traces.sampler", "erda");
    return properties;
  }
}
